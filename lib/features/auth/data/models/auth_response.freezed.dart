...
@JsonKey(name: 'access') String get accessToken;@JsonKey(name: 'refresh') String get refreshToken;@JsonKey(name: 'user') UserModel? get user;
...
@useResult
$Res call({
@JsonKey(name: 'access') String accessToken,@JsonKey(name: 'refresh') String refreshToken,@JsonKey(name: 'user') UserModel? user
});
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function(@JsonKey(name: 'access')  String accessToken, @JsonKey(name: 'refresh')  String refreshToken, @JsonKey(name: 'user')  UserModel? user)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _AuthResponse() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function(@JsonKey(name: 'access')  String accessToken, @JsonKey(name: 'refresh')  String refreshToken, @JsonKey(name: 'user')  UserModel? user)  $default,) {final _that = this;
switch (_that) {
case _AuthResponse():
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function(@JsonKey(name: 'access')  String accessToken, @JsonKey(name: 'refresh')  String refreshToken, @JsonKey(name: 'user')  UserModel? user)?  $default,) {final _that = this;
switch (_that) {
case _AuthResponse() when $default != null:
return $default(_that.accessToken,_that.refreshToken,_that.user);case _:
  return null;
...
class _AuthResponse implements AuthResponse {
  const _AuthResponse({@JsonKey(name: 'access') required this.accessToken, @JsonKey(name: 'refresh') required this.refreshToken, @JsonKey(name: 'user') this.user});
